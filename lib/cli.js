...
export default class Cli {
    ...
    constructor ( config, { searchCommandShort, searchCommand, optionsAutoShorts } = {} ) {
        this.#searchCommandShort = Boolean( searchCommandShort );
        this.#searchCommand = Boolean( searchCommand );
        this.#optionsAutoShorts = Boolean( optionsAutoShorts );
    ...
    // properties
    get searchCommandShort () {
        return this.#searchCommandShort;
    }
    ...
    get optionsAutoShorts () {
        return this.#optionsAutoShorts;
    }
