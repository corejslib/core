...
export default class DigitalSize {
    ...
    get kilobytes () {
        return this.#bytes / UNIT_BYTES.kilobyte;
    }

    get megabytes () {
        return this.#bytes / UNIT_BYTES.megabyte;
    }

    get gigabytes () {
        return this.#bytes / UNIT_BYTES.gigabyte;
    }

    get terabytes () {
        return this.#bytes / UNIT_BYTES.terabyte;
    }

    get petabytes () {
        return this.#bytes / UNIT_BYTES.petabyte;
    }

    get kibibytes () {
        return this.#bytes / UNIT_BYTES.kibibyte;
    }

    get mebibytes () {
        return this.#bytes / UNIT_BYTES.mebibyte;
    }

    get gibibytes () {
        return this.#bytes / UNIT_BYTES.gibibyte;
    }

    get tebibytes () {
        return this.#bytes / UNIT_BYTES.tebibyte;
    }

    get pebibytes () {
        return this.#bytes / UNIT_BYTES.pebibyte;
    }
