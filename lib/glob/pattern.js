...
export default class GlobPattern {
    ...
    get regexpCaseInsensitive () {
        if ( !this.#regexpCaseInsensitive ) {
            this.#regexpCaseInsensitive = new RegExp( this.#regexp.source, "iv" );
        }

        return this.#regexpCaseInsensitive;
    }
    ...
    test ( testPath, { prefix, absolute, normalize, caseSensitive = true } = {} ) {
        if ( !testPath ) {
            ...
            if ( caseSensitive ) {
                ...
                return this.regexpCaseInsensitive.test( testPath );
            }
        }
    }
