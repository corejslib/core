...
export async function rm ( path, { force, maxRetries = 0, recursive, retryDelay = 100, keepRoot } = {} ) {
    KEEP_ROOT: if ( keepRoot ) {
        let files;
    ...
    return fs.promises.rm( path, { force, maxRetries, recursive, retryDelay } );
}
