...
export default class GitCommit extends GitMessage {
    ...
    get fixes () {
        if ( this.#fixes === undefined ) {
            ...
            this.#fixes = new Set( links.sort( this.constructor.linksComparator ) );
        }
    ...
    get links () {
        if ( this.#links === undefined ) {
            ...
            this.#links = new Set( links.sort( this.constructor.linksComparator ) );
        }
    ...
    get releaseVersion () {
        if ( this.#releaseVersion === undefined ) {
            ...
            for ( const tag of this.tags ) {
                if ( /^v\d+\.\d+\.\d+/.test( tag ) && SemanticVersion.isValid( tag ) ) {
