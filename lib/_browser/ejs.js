...
const START_TOKENS = new Set( [ "<%", "<%-", "<%_", "<%=", "<%#" ] ),
    ...
    SAFE_GLOBALS = new Set( [ "NaN", "Infinity", "undefined", "isNaN", "isFinite", "parseInt", "parseFloat", "encodeURIComponent", "decodeURIComponent", "encodeURI", "decodeURI" ] ),
    CACHE = new CacheLru( {
        "maxSize": 1000,
    } ),
    PROXY = {
        ...
        get ( target, key, receiver ) {
            ...
            else if ( typeof key === "string" && SAFE_GLOBALS.has( key ) ) {
